      ...
      <div className="outerContainer">
        <div className="aboutSection grid grid-2-col about-grid">
          ...
          <div className="bioSection">
            ...
            <p className={learnMore ? "bioText newP" : "learnMore"}>
              <br /> <br />
              Penny has attended numerous Labour Interest and Rights Arbitration
              hearings, as well as hearings at the Ontario Human Rights
              Commission, Ontario Labour Relations Board and the Workplace
              Safety and Insurance Board and acted as the Chief Negotiator for
              many public sector organizations and has negotiated with
              provincial and national unions such as Unifor, CUPE, ONA, ETFO,
              OSSTF and others.
              <br /> <br />
              ...
              District Immigrant Services. Currently Penny is the Vice Chair of
              the Board of Governors for Martin Luther University and on the
              Board of the Public Sector Health and Safety Association of
              Ontario.
              <br /> <br />
              ...
              certified in Mediation and Dispute Resolution and has a Green Belt
              in Lean Six Sigma. Penny enjoys contributing to the vision,
              mission and strategy of organizations and bringing people together
